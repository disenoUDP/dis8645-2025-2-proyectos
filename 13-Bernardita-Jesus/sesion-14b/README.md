...
partir, para cortar una polisuperficie abierta

superficie desde curvas planas

cargar todos los componentes en un lado, al menos el mayor peso y poner el sensor al lado contrario apuntando al ñado que no tiene tanto peso, y en el lado de no tanto peso, poner la pantalla para que se pueda ver la cara de nuestro pajarito
