...
### Propuesta de desarrollo de la carcasa

Nos inclinamos por realizar la carcasa mediante impresión 3D, ya que esta técnica permite efectuar múltiples testeos y lograr un encaje preciso entre las piezas y los componentes electrónicos. Además, la impresión 3D facilita la fabricación directa de un molde para silicona, optimizando el proceso de prototipado.
