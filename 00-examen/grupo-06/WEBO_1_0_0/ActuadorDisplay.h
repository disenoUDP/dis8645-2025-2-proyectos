...
public:
  ...
  // pantalla para la AVA girando 
  void girandoDisplay();

  void celebracionDisplay();
  ...
  int tiempoActualCelebracion = millis();

  int tiempoNuevoCelebracion = 0;

  int intervaloCelebracion = 8 * segundoNumero;
