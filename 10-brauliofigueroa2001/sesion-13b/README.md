...
## taller clase viernes 7 de noviembre
...
- que todo lo programable sea innecesario y que todo sea mecánico - miguel
- ustedes no son ni sus presiones internas ni sus presiones externas, están en un punto medio
- una especie de robot estilo r2d2, tongas, con muchos elementos externos, algo más "chatarrero"? materialidad diversa como metales, cartón quizás
- encapsular todos los elementos peligrosos, que nadie se pueda quemar interactuando con el objeto
- quizá encerrar todo lo que pueda fallar dentro de algo que no pueda salir hacia fuera

- sensores/actuadores

- separar lo funcional de lo que se va a quemar?
- que el humo/vapor salga por detrás de la máquina, simulando un peo
- formas de cómo hacer el humo o vapor que va salir expulsado de la máquina
