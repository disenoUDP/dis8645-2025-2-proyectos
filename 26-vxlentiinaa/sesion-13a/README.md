...
no vine porque venía viajando, pero rellené el ReadMe con lo que me contaron mis compañeras y revisando sus reposss :)

## Apuntes

- Ahora hay un segundo repositorio en donde se trabajará el proyecto 3. Empezar a usar este, para anotar todos los apuntes.
- Terminar de tomar apuntes en el repositorio anterior y a ordenar algunas cosas que falten. (Mis compañeras me dijeron que el martes 11 se cierra definitivo)
- ml5.js
- Referente: (https://annaridler.com/bloemenveiling) trabaja con tulipanes, flores y naturalezza, mezclando la tecnología.
...
Es un programa que te permite instalar fácilmente software en el computador, especialmente en macOS (aunque también existe para Linux). Usaremos esto para poder escribir en github pero desde la terminal del computador.
