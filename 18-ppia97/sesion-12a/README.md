...
- Puede escribir incluso cuando está casi sin punta.

- Guarda restos de huellas digitales.

- Su longitud disminuye cada vez que se usa.

- Hecho madera y grafito, pero actúa como una sola cosa.

- Sale un olor reconocible cuando se saca punta.

- Puede romperse con una presión mínima.

- El borrador del extremo se endurece con el tiempo.

- Deja polvo fino del grafito que ensucia el papel.

- Hace un sonido diferente según el tipo de hoja.

- Puede rodar por la mesa.

- Es útil incluso roto, si se le saca punta nueva.

- Puede marcar una pared o un papel sin intención.

- Se calienta con la mano después de unos minutos de uso.

- Puede usarse como herramienta o juguete.

- Tiene una “vida útil” que se mide en centímetros.
